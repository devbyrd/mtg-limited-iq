...
interface PlaneswalkerSymbolProps {
  className?: string;
  size?: number | string;
}

/**
 * Official WOTC Magic: The Gathering Planeswalker Spark vector icon.
 * Vector coordinates match official Scryfall / WOTC Planeswalker symbology.
 */
export const PlaneswalkerSymbol: React.FC<PlaneswalkerSymbolProps> = ({
  className = 'w-5 h-5',
  size,
}) => {
  return (
